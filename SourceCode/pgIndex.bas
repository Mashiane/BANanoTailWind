...
Sub Initialize
	...
	body.Div(Me, "", "body").TextColorIntensity("gray", 700).Antialiased
	'
	BuildNavBar
...
Sub BuildMain
	...
	sdiv.BackgroundRepeat("no-repeat")
	sdiv.Pop
End Sub
...
Sub BuildNavBar
	...
	div2.JustifyBP(div2.BP_LG, "start")
	div2.Pop
	...
	btndownload.ML(3)
	btndownload.MB(3)
	btndownload.SetTransition(Array("all", "0.15s", "ease", "0s"))
	btndownload.Pop
	'
	Dim di As TWElement
	di.Icon(Me, btndownload.ID, "di", "fas fa-arrow-alt-circle-down")
	di.Pop
	'
	Dim ds As TWElement
	ds.Span(Me, btndownload.ID, "ds", " Download")
	ds.Pop
End Sub
